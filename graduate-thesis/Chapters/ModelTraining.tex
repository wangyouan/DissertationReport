...
Details of the parameters can be found in Table~\ref{tb:parameters}, the reason why I choose these parameter are list in Chapter~\ref{ch:parameter_selection}.
