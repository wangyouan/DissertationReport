...
\begin{figure}[h]
	...
	\caption{Testing result in time period 2010-01-06 to 2015-01-06}
...
\begin{figure}[h]
	...
	\caption{Testing result in time period 2010-01-06 to 2015-01-06 (continue)}
...
The best learning algorithm under this circumstance is Random Forest, which has the second best CDC (the best algorithm is a combined method whose trend model is also based on Random Forest) and lowest error in amount prediction. And as both linear classifiers, the CDC result of Logistic Regression and SVM are almost same\\
...
\begin{table}[h]
	...
	\begin{tabular}{|l|l|}
		...
		\textbf{Random Forest + SVM} & 63.55\% \\ \hline
		\textbf{ANN + Random Forest} & 65.82\% \\ \hline
	\end{tabular}
	\caption{Average CDC in time period 2010-01-06 to 2014-01-06}
