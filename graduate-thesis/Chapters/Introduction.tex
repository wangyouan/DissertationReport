...
\begin{itemize}
	...
	\item Chapter 9 to 10 is about results. Chapter 9 introduces testing environment; Chapter~\ref{ch:AccuracyResult} shows testing results of different learning method; Chapter~\ref{ch:speedResult} compares running performance of every algorithm.
