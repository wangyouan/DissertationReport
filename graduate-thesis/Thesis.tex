...
This study is to apply and compare different data mining and machine learning methods to predict the price of stock in Hong Kong Stock Exchange Market. This report describes the algorithm and usage of ANN, SVM, linear regression, logistic regression and random forest. It is found that ANN and linear regression are the most powerful learning method to predict stock price, while SVM and logistic is the best algorithm to predict stock changing direction.
}\\
